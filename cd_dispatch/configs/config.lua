...
Config.JobCallCommands = { 
    ...
    Civilian_Commands = {
        { job_label = 'Police',         command = '000',        anonymous = false, 	job_table = {'police'} },
        { job_label = 'Police',         command = 'oooa',       anonymous = true,   job_table = {'police'} },
...
Config.PoliceAlerts = {
    ...
    whitelisted_jobs = {'police', 'ambulance'}, --These jobs will NOT trigger these alerts.
